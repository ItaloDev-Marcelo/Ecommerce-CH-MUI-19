     ...
     <Stack>
         <Stack component='section' id='informationSection' maxWidth={{lg: '700px'}} marginTop={{xs: '4em', sm: '37rem', md: '45rem', lg: '4em'}} >
            ...
            <Stack sx={{display: 'flex', flexDirection: {xs: 'column', lg: 'row'}, alignItems: 'center', padding: '1em 0'}}>
               ...
               <Button onClick={ShowTme} id='orange-btn' sx={{backgroundColor: 'orange',color: '#000', marginLeft: {lg: '1em'} ,fontWeight: 700, textTransform: 'lowercase', width: '100%',padding: '1em 0', height: '50px', marginTop: '1rem', borderRadius: '10px',textTransform: 'lowercase'}}> <img src={Cart} alt='cart-icon' style={{width: '20px', marginRight: '1em'}} />  <Typography  fontWeight='700' textTransform='capitalize'>A</Typography>  dd to cart</Button>
            </Stack>
